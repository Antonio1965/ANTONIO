window.addEventListener('load', function (){
    let iniciar = document.querySelector('#products');
    ...
    iniciar.addEventListener('submit', function (e){
       ...
       }; let campoMarerial = document.querySelector('#material');
       ...
       }; let campoCategaria = document.querySelector('#category');
       if (campoCategaria.value == ""){
